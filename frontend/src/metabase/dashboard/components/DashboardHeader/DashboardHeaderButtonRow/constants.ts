...
export const DASHBOARD_VIEW_ACTIONS = [
  ...
  ...DASHBOARD_DISPLAY_ACTIONS,
  // DASHBOARD_ACTION.DASHBOARD_HEADER_ACTION_DIVIDER, // hidden this as we dont need it
  // DASHBOARD_ACTION.DASHBOARD_BOOKMARK, // hidden this as we dont need it
  // DASHBOARD_ACTION.DASHBOARD_INFO, // hidden this as we dont need it
  // DASHBOARD_ACTION.DASHBOARD_ACTION_MENU, // hidden this as we dont need it
